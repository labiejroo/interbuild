...
class MobileHome extends React.Component {
  render(props) {
    ...
    return (
      <>
        <div id="MOBILE__website__whatWeDo">
          <div className="MOBILE__website__whatWeDo__halfWhatWeDoSection">
            ...
            <div className="MOBILE__website__whatWeDo__halfWhatWeDoSection__sectionContent">
              #Zostań w domu, remont zostaw nam.
              <i className="fa fa-cog fa-spin fa fa-fw"></i>
              <br></br>
              <br></br>
        ...
        <div id="MOBILE__website__offer">
          <br></br>
          <br></br>

          <div className="MOBILE__website__offer__sectionContent">
            <br></br>
            <br></br>
            <div className="MOBILE__website__offer__sectionContent__Columns">
              <div className="MOBILE__website__offer__sectionContent__Columns__Column">
                <div className="MOBILE__website__offer__sectionContent__Columns__Column__photosCarouselMulti">
                  <ImageCarouselMulti />
                </div>
              </div>
              <div className="MOBILE__website__offer__sectionContent__Columns__Column">
        ...
        <div className="MOBILE__website__decorationArrowAnimation">
          <DecorationArrow
            point="MOBILE__website__portfolio"
            src={downArrowGraphic}
            width={50}
            height={50}
          />
        </div>
        <div id="MOBILE__website__portfolio">
          <div className="MOBILE__website__portfolio__imgSection">
            <h4>Portfolio</h4>
            <div
              data-aos="fade-left"
              className="MOBILE__website__portfolio__imgSection__beforeAfterImgs"
            >
              <div className="MOBILE__website__portfolio__imgSection__beforeAfterImgs__compareImages website__portfolio__imgSection__beforeAfterImgs__beforeImg">
                <ImagePort src={img3A} />
                <div className="MOBILE__website__portfolio__imgSection__beforeAfterImgs__beforeImg__beforeImgGraphic">
                  <img
                    className="MOBILE__website__portfolio__imgSection__beforeAfterImgs__beforeImg__beforeImgGraphic__draftGraphic"
                    src={draftGraphic}
                  />
                </div>
              </div>
              <div className="MOBILE__website__portfolio__imgSection__beforeAfterImgs__compareImages website__portfolio__imgSection__beforeAfterImgs__afterImg">
                <ImagePort src={img3B} />
                <div className="MOBILE__website__portfolio__imgSection__beforeAfterImgs__afterImg__afterImgGraphic">
                  <img
                    className="MOBILE__website__portfolio__imgSection__beforeAfterImgs__afterImg__afterImgGraphic__wallGraphic"
                    src={wallGraphic}
                  />
                </div>
              </div>
        ...
        {this.props.isHomeViewOpen === true && (
          <div
            className="MOBILE__website__seeMore"
            onClick={this.props.stateChange}
          >
            Zobacz wiecej
          </div>
        )}
        <div id="MOBILE__website__contact">
          <h4>Kontakt</h4>
          <div className="MOBILE__website__contact__sectionContent">
        ...
        <div className="MOBILE__website__footer">
